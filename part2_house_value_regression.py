...
class Regressor():
    def __init__(self, x=None, nb_epoch=100, learningRate=0.01, neuronArchitecture=[13,9], batchSize=64, minImprovement=0.005, paramDict=None):
